...
package org.bigbluebutton.modules.listeners.business 
{
	...
	{		
		...
		public function changeGain(evt:ChangeGain):void {
			_listenersService.changeGain(evt.userid, evt.gain);
		}
	}
}
